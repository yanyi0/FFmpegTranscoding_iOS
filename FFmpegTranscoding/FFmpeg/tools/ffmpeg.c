...
#endif
//    avdevice_register_all();
//    printf("--------------start print encoder ander decoder\n");
//    char info[40000] = {0};
//    AVCodec *c_temp = av_codec_next(NULL);
//    while (c_temp != NULL) {
//        if (c_temp->decode != NULL) {
//            av_log(NULL, AV_LOG_INFO,"%sdecode:", info);
//        } else {
//            av_log(NULL, AV_LOG_INFO, "%sencode:", info);
//        }
//        switch (c_temp->type) {
//            case AVMEDIA_TYPE_VIDEO:
//                av_log(NULL, AV_LOG_INFO, "%s(video):", info);
//                break;
//            case AVMEDIA_TYPE_AUDIO:
//                av_log(NULL, AV_LOG_INFO, "%s(audio):", info);
//                break;
//            default:
//                av_log(NULL, AV_LOG_INFO, "%s(other):", info);
//                break;
//        }
//        av_log(NULL, AV_LOG_INFO, "%s[%s]\n", info, c_temp->name);
//        c_temp = c_temp->next;
//    }
//    printf("--------------finish print encoder ander decoder\n");
